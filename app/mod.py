...
def get_customer_by_email1():
    ...
    cursor.execute(query,(idq,))

    row = cursor.fetchone()

    print(row)
get_customer_by_email1()
 

def insertdata():
    """Query for a specific customer in the database by the email"""
    cursor = connect()
    query = """insert into customers (id, email, givenname, surname, password, telephone, tos_agree, gender, dob, billto_address1, billto_address2, billto_city, billto_state, billto_postalcode, shipto_address1, shipto_address2, shipto_city, shipto_state, shipto_postalcode, region) values (10000, 'san@gmail.com', 'Teresa', 'Henry', 'san', '(756)087-0677', 'None', 'Male', '2014-06-09', '49731 Northview Avenue', 'None', 'Fowler', 'MD', '77134-6809', '49731 Northview Avenue', 'None', 'Fowler', 'MD', '77134-6809', 'None')"""
